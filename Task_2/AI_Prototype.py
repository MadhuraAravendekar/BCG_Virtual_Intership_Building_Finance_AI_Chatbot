...
final_report = pd.read_csv('../Task_1/SEC_data_cleaned.csv')
summary_report = pd.read_csv('../Task_1/Summary_final_report.csv')
...
while True:
    ...
    if user_input.lower() == "exit":
        ...
        if company_input not in ['Apple', 'Microsoft', 'Tesla']:
            ...
            print("\nThe data for the fiscal year 2023, 2024, and 2025 is currently available")
